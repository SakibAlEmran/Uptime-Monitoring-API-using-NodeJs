/* 
    Title: User Handler
    Descrition: Handle users (POST, GET, PUT & DELETE) request
    ...
    if(firstName && lastName && phone && password && tosAgreement){
        ...
        data.read('users', phone, (err1) => {
            if(err1){
                ...
                //store the user to database of users
                ...
                callback(500, {
                    error: 'there was a problem in server side. user may exist!',
                });
            }
        });
        ...
        callback(400, {
            error: 'you have a problem in your request. Make sure you have all the valid fields value'
        });
    }
            ...
            if(tokenId){
                ...
                data.read('users', phone, (err1, userData) => {
                    if(!err1 && userData){
                        ...
                        callback(500, {
                            error: 'There was a server side error, user may not exist!',
                        });
                    }
                });
            }else{
                callback(403, {
                    error: "Authenciation failure!."
                });
            }
        });
    }else{
